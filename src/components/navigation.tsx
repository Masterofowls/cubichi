  ...
  return (
    ...
    >
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="font-display text-xl sm:text-2xl font-bold bg-gradient-to-r from-sky-600 to-emerald-600 bg-clip-text text-transparent">
              Кубики-Самоучки
            </span>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            <a
              ...
              className="ms-2 flex items-center gap-2 px-4 py-2 rounded-lg bg-sky-600 text-white text-sm font-medium hover:bg-sky-700 transition-colors min-h-[44px]"
            >
              <svg
                className="w-4 h-4"
                viewBox="0 0 24 24"
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-lg text-gray-600 hover:text-sky-600 hover:bg-sky-50 transition-colors min-h-[44px] min-w-[44px] inline-flex items-center justify-center"
      ...
      <dialog
        ...
        ref={dialogRef}
        className="nav-dialog lg:hidden fixed inset-0 top-16 z-40 m-0 max-h-none max-w-none w-full h-[calc(100%-4rem)] border-0 bg-transparent p-0 open:flex open:flex-col"
        aria-label="Мобильное меню"
        onClose={() => setMobileOpen(false)}
      >
        <m.div
          className="relative bg-white border-t border-gray-100 shadow-xl mt-auto"
          ...
          <div className="px-4 py-3 space-y-1">
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 mx-4 mt-3 px-4 py-3 rounded-lg bg-sky-600 text-white font-medium hover:bg-sky-700 transition-colors min-h-[44px]"
              >
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
