      ...
      <div className="container mx-auto px-4">
        ...
        <FadeIn delay={0.1}>
          <p className="text-lg text-slate-600 text-center mb-12 max-w-2xl mx-auto">
            Выберите игру, которая подходит вашему ребенку. Каждая игра
            рассчитана на 2–4 участников и содержит подробные правила.
          </p>
        </FadeIn>
          ...
          {games.map((game) => (
            <StaggerItem key={game.slug}>
              <HoverCard className="h-full">
                <div className="bg-white rounded-2xl shadow-lg ring-1 ring-black/[0.03] overflow-hidden h-full flex flex-col">
                  <div
                    className={`h-32 bg-gradient-to-br ${game.color} relative overflow-hidden`}
                  >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <Link
                      ...
                      className={`inline-flex items-center px-5 py-2.5 rounded-xl text-white font-medium transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 ${game.btnColor}`}
                    >
                      Подробнее
                      <svg
